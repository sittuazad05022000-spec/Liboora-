...
>
> **Why archived: `ACN-001` is CLOSED. The rate-limiting policy it awaited is specified in Authentication PRD v2.0 Chapter 8 §8.3 as `CFG-1`…`CFG-4`, with values and rationale in `20-configuration/CONFIGURATION_GUIDE.md`.**
>
