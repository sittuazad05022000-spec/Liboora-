...
| **Supersedes** | `BASELINE-2026-08-04-C` |
| **Status** | **Locked** |
| **Date** | 2026-08-04 |
| **Declared by** | Enterprise Architecture review (`DOCUMENTATION_AUDIT-001`); re-issued by the **Governance Closure Phase**; extended by the **`PRD-004` Stage 7 freeze**, then by the **`PRD-005` Stage 7 freeze** |
| **Authority** | `ADR-0008`, `ADR-0009`, `ADR-0010`, `ADR-0011`, `ADR-0013`, `ADR-0014`, `ADR-0015`, `ADR-0016`, `ADR-0017`, `ADR-0018`, `ADR-0019` |
...
| `00-governance/adr/ADR-0001` … `ADR-0019` | Accepted | Authoritative, binding |
