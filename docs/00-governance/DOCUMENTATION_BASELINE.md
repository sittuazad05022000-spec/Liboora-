...
| **Supersedes** | `BASELINE-2026-08-04-D` |
| **Status** | **Locked** |
| **Date** | 2026-08-04 |
| **Declared by** | Enterprise Architecture review (`DOCUMENTATION_AUDIT-001`); re-issued by the **Governance Closure Phase**; extended by the **`PRD-004` Stage 7 freeze**, then by the **`PRD-005` Stage 7 freeze**, then by the **`PRD-007` Stage 7 freeze** |
| **Authority** | `ADR-0008`, `ADR-0009`, `ADR-0010`, `ADR-0011`, `ADR-0013`, `ADR-0014`, `ADR-0015`, `ADR-0016`, `ADR-0017`, `ADR-0018`, `ADR-0019`, `ADR-0020` |
...
|---|---|---|
| `00-governance/DOCUMENTATION_BASELINE.md` | **BASELINE-2026-08-04-D** | **This document** |
| `00-governance/adr/ADR-INDEX.md` | Active | Authoritative |
| `00-governance/adr/ADR-0001` … `ADR-0020` | Accepted | Authoritative, binding |
...
| **2** | Accepted ADRs (`ADR-0001` … `ADR-0020`) | Structural decisions |
...
**Rank 3 holds six module baselines and they do not overlap.** The Authentication PRD governs `BC-18`; the Student
Identity PRD governs `BC-10`; the Student Management PRD governs `BC-01` Enrollment; the Membership PRD governs
`BC-02`; the Seat Management PRD governs `BC-04` Seating; the Library
