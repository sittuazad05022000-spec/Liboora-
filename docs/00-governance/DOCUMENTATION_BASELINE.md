...
| `40-implementation/seat-management/PRD-007_DEVELOPER_GUIDE.md` | **v1.0** | Developer entry point for `BC-04` Seating, derived from the frozen PRD. **Navigational and explanatory — carries no requirement and no authority** |
