...
```
outward collision -- ADR-0057... cites FIL-GAP-017, which is defined nowhere
outward collision -- ADR-0057... cites FIL-CFG-016, which is defined nowhere
```
