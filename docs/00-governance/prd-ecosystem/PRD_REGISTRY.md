...
| `PRD-008` | Revenue & Finance | **`BC-05` Fee & Collection** | `[CORE]` | V1 | **`DRAFT`** — [`revenue-finance/PRD-008_REVENUE-AND-FINANCE.md`](../../30-product/revenue-finance/PRD-008_REVENUE-AND-FINANCE.md) **v1.7**, 2026-08-15, moved `PLANNED` → `DRAFT` by the **Governance Owner** under [`ADR-0043`](../adr/ADR-0043-prd-019-creation-and-prd-008-freeze-blocker-closure.md) §8.2 *(was `PLANNED` — see `GCP-14` in §4.3, which remains **OPEN**)*. **`DRAFT` is not `FROZEN`**: no `DOCUMENTATION_BASELINE.md` §3 row exists, and Stages 5–6 are not performed | — |
