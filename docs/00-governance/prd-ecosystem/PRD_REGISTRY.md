...
| `PRD-008` | Revenue & Finance | **`BC-05` Fee & Collection** | `[CORE]` | V1 | **`DRAFT`** — [`revenue-finance/PRD-008_REVENUE-AND-FINANCE.md`](../../30-product/revenue-finance/PRD-008_REVENUE-AND-FINANCE.md) **v1.7**, 2026-08-16, moved `PLANNED` → `DRAFT` by the **Governance Owner** under [`ADR-0043`](../adr/ADR-0043-prd-019-creation-and-prd-008-freeze-blocker-closure.md) §8.2 *(was `PLANNED` — see `GCP-14` in §4.3, which remains **OPEN**)*. **`DRAFT` is not `FROZEN`**: no `DOCUMENTATION_BASELINE.md` §3 row exists, and Stages 5–6 are not performed | — |
...
| `PRD-023` | Settings & Configuration | **`BC-25` Configuration** | `[GENERIC]` | V1 | `PLANNED` | Master PRD §8 **module 18**; owns the settings hierarchy, feature flags, branding *values*, secret *references*, the `E-19` typed-accessor contract and `LCFG-*` resolution semantics. Registered by [`ADR-0017`](../adr/ADR-0017-bc-25-configuration-ownership.md) |
