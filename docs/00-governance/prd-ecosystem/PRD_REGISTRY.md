...
|---|---|---|---|---|---|---|
| `PRD-022` | SaaS Billing | **`BC-20` Subscription & Billing** | `[GENERIC]` | V1 | **`DRAFT`** — [`saas-billing/PRD-022_SAAS-BILLING.md`](../../30-product/saas-billing/PRD-022_SAAS-BILLING.md) **v0.1**, 2026-08-05 | Master PRD §8 module 17; owns `Subscription` · `SubscriptionInvoice`; sole writer of entitlement inputs |
