...
| **Security considerations** | The role most frequently exercised against live tenant data, therefore the greatest insider risk. Every elevation records requester, approver, tenant, purpose and expiry, and terminates automatically at `CFG-12` (1 hour) |
