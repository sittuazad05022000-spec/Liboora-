...
| **Baseline** | **`BASELINE-2026-08-20-B`** — issued by this admission (`DOCUMENTATION_BASELINE.md` §7 rule 4, a Rank 3 document entering the baseline), superseding `BASELINE-2026-08-20-A`, the baseline current when this text was authored. The **second** suffix advance within a single day |
| **Date** | 2026-08-20 |
