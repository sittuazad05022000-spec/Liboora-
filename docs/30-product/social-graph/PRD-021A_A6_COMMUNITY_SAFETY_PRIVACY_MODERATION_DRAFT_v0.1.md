...
| **A6-F3** | ⛔ `BC-13` has **ZERO** inbound edges | Live §7 scan: **0** rows target `BC-13`. `PRD-020` `F-3` | ⛔ **Outbound reporting has NO EDGE.** §2.3 — every dependent requirement self-blocked |
