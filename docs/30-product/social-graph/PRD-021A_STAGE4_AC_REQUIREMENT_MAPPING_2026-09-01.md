...
| **Edge count** | **28** | **28** — `LIBOORA_BOUNDED_CONTEXT_MAP.md` **L654**: *"`E-01`…`E-26`, `E-28`, `E-29` — 28 edges, with `E-27` a deliberate gap"*; 28 defined rows | ✅ **28** |
| New `PERM-*` | 0 | 0 | ✅ |
...
resolves this at **L654** — `E-27` is a **deliberate gap**, and the defined-row count is 28. The
