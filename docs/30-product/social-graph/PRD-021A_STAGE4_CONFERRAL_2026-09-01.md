...
| ⛔ Does **not** close `LCM-FR-047` | A1's `LCM-FR-*` register skips exactly one number. This is **pre-disclosed** by A1 **§24 L883–884**, **L1465** and **L1502**, deliberately *"not closed by inventing a requirement"* and *"not closed by renumbering"*. Stage 4 does not require contiguity; **Stage 5 does**, and it is recorded as a Stage-5 input, not repaired here |
