...
| ⚠️ The other **55** parameters *(was **65** at v0.4 — ⭐ **10** `CFG-*` left this row via `ADR-0154`)* | ⛔ No operation×role source | — | ⛔ Not designed | ⭐ **Future / V2** |
...
49 / 104** — ⛔ **55 parameters are NOT authorized and MUST NOT be prototyped**.
