...
- [ ] Every behavioural change traces to a `AUTH-n.n`, `BR-n.n` or an ADR
- [ ] No requirement invented. If the specification is silent, **raise it — do not decide it**
- [ ] No `CFG-*` value hardcoded outside the configuration module
...
| Invented invitation security properties | `AR-4` — *"do not invent"* |
...
`DOCUMENTATION_BASELINE.md` · Authentication PRD v2.0 Chapter 11 · `MASTER_PRD.md` ·
`ADR-0001`…`ADR-0008` · `CONFIGURATION_GUIDE.md` · `TASK-D10-remove-demo-surfaces.md` ·
