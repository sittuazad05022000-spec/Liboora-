...
Verified mechanically against `PRD-MEMBERSHIP-MANAGEMENT.md` (`PRD-005`, ⭐⭐ **v1.5**, ⭐ **`FROZEN`**) by
...
| Prefix | Meaning | Count | Range | Source |
|---|---|---|---|---|
| `MM-FR-n` | Functional requirement | ⭐ **143** | `MM-FR-001` … `MM-FR-137` + `MM-FR-057a`, `119a`, `121a`, `123a`, `127a`, `131a` | §§2–11, 19–20, ⭐ **§2.4a, §16.3a, §17.1a** |
...
⭐⭐ **Total Membership Management identifiers: 366**, of which **353 carry obligation** and **13 are `MM-GAP-*` open
questions carrying no authority**. Of the 353, **247 are obligations an acceptance criterion can verify** (every
...
⭐⭐ **Measured coverage — 146 / 247 = 59.1%**, and **77 / 81 = 95.1%** across the five *rule* registers
(`MM-BR`, `MM-INV`, `MM-EVT`, `MM-XC`, `MM-PO`). Per register: `MM-BR` **31/35** · `MM-INV` **12/12** ·
`MM-EVT` **7/7** · `MM-XC` **16/16** · `MM-PO` **11/11** · ⭐ `MM-FR` **60/143** · `MM-NFR` **7/14** ·
`MM-CFG` **2/9**.
