...
| Field | Value |
|---|---|
| **Trace** | `LRR-FR-017`, `LRR-FR-018`, `LRR-FR-019` · `LRR-BR-001`…`LRR-BR-008` · `LRR-XC-014`…`LRR-XC-016` · AC `LRR-AC-010`…`LRR-AC-012` |
...
| Field | Value |
|---|---|
| **Trace** | `LDR-BR-009` · `LDR-XC-008`, `LDR-XC-013`…`LDR-XC-015` · AC `LDR-AC-012`…`LDR-AC-014` |
