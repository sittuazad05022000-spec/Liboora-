...
>
> **Why archived: this guide was written against the absent v1 specification. Its folder listing shows eleven empty slots, and it states in several places that the specification and the event register are not in the repository. Every such claim is now false. Use `40-implementation/DEVELOPER_HANDOFF.md` instead.**
>
