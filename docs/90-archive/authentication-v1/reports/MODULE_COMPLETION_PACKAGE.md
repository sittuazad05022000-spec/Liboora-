...
>
> **Why archived: its status "INCOMPLETE — 4 of 5 deliverables" and "NOT certifiable as the authoritative baseline" were both consequences of `D-7`. Deliverable 1 (the Final Enterprise PRD) now exists as Authentication PRD v2.0 and the baseline is declared in `00-governance/DOCUMENTATION_BASELINE.md`.**
>
...
|---|---|---|
| [`ARCHITECTURE_RULINGS.md`](../../../10-architecture/ARCHITECTURE_RULINGS.md) | **v1.1** | ✅ Seven rulings `AR-1`…`AR-7`. `AR-5`, `AR-6`, `AR-7` added for this module |
| [`LIBOORA_BOUNDED_CONTEXT_MAP.md`](../../../10-architecture/LIBOORA_BOUNDED_CONTEXT_MAP.md) | **v1.2** | ✅ §14 rulings table + new §14.2 authentication stage sequence. Context count **31 (23 V1), unchanged** |
| [`MASTER_PRD.md`](../../../30-product/MASTER_PRD.md) | **v1.3** | ✅ §31 cross-references realigned; §36 changelog. **No requirement added, removed or altered** |
| [`LIBOORA_ENTERPRISE_ARCHITECTURE.md`](../../../10-architecture/LIBOORA_ENTERPRISE_ARCHITECTURE.md) | v2.0 | ✅ Unmodified — no ruling required a change |
| [`LIBOORA_MODULE_DEPENDENCY_MATRIX.md`](../../../10-architecture/LIBOORA_MODULE_DEPENDENCY_MATRIX.md) | v1.0 | ⚠️ Unmodified. Known `lib/contracts` path defect deferred as `R-5` (recorded in Master PRD §31) |
...
| Artefact | State |
|---|---|
| [`README.md`](../../../10-architecture/README.md) | `STATUS = TRANSFER PENDING — NOT LOCKED` (line 24). *"Its purpose is custody, not authorship"* |
