...
| [`student-management/PRD-004_TRACEABILITY.md`](./30-product/student-management/PRD-004_TRACEABILITY.md) | v1.0 | Ten new registers, zero collisions. ⚠ Its coverage figure is **unsubstantiated** and its §4 event numbering **contradicts** PRD §7.4 — findings `RF-07`, `RF-04`. **Not part of the specification** |
