...
| **Supersedes** | v1.0 (Foundation Document) |
...
| Capability | Architectural owner | Abstraction that must exist | Candidate implementation (V1) | Approved in EA v2.0? |
|---|---|---|---|---|
...
| **MP-CON-08** | The Enterprise Architecture v2.0 is **approved and final**. This PRD may not modify it. Conflicts are resolved by amending the PRD or raising an ADR. |
...
|---|---|---|---|
| **MP-DEP-01** | Approved Enterprise Architecture v2.0 | Internal — **satisfied** | Everything |
...
| **Bounded Context Map v1.0** | Approved — governing |
| **Module Dependency Matrix v1.0** | Approved — governing |
| ADR Summary | Listed in v1.0 |
| Architecture Handbook | Listed in v1.0 |
| System Architecture | Listed in v1.0 |
